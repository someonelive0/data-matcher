...
func TestRe2Concurrency(t *testing.T) {
	logLine := `139.162.189.33 - 13988776655 - 13988776655 [18/Apr/2018:07:52:34 +0200] "GET /420191f0.css HTTP/1.1" 200 136 "-" "Mozilla/5.0 (Windows NT 6.3; WOW64; Trident/7.0; rv:11.0) like Gecko" "-"`
	// logLine = `xxx`
	...
	loc := r.FindIndex([]byte(logLine))
	t.Logf("re2 FindIndex %#v, %d", loc, len(loc))
